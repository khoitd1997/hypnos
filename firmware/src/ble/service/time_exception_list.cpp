...
TEST_CASE("replace() method") {
  ...
  SUBCASE("replace with normal array works") {
    ...
    time_t           test_normal_array[test_normal_array_size] = {0};
  ...
  SUBCASE("replace with too many elements errors") {
    time_t test_too_big_array[exception_list.max_size() * 2 + 2] = {0};
    REQUIRE(
